...
<?php include("../header2.inc.php"); ?>
	...
	<p>Name* <input type="text" size="30" name="name" />&nbsp;&nbsp;
	
	Phone* <input type="text" size="14" name="phone" />&nbsp;&nbsp;
	
	E-mail* <input type="text" size="35" name="email" /></p>
	
	<p style="float:left;margin-right:1em;line-height:2em;">
	Street address* <br /><input type="text" size="40" name="address" /><br />
	
	City* <select name="city">
		<option value=""></option>
			<option value="Stamford">Stamford</option>
			<option value="NewCanaan">New Canaan</option>
			<option value="Greenwich">Greenwich</option>
			<option value="Darien">Darien</option></select><p/>
	
	<p>
	<input type="radio" name="retrieval" value="Delivery" /> Pick-up and delivery ($2)<br />
	<input type="radio" name="retrieval" value="Pick-up" /> Pick-up only ($1 - you will retrieve racket from Center Court Tennis Shop in New Canaan)</p>
	...
	Power 
		<input type="radio" name="scale" value="power4" />&nbsp;&nbsp;
		<input type="radio" name="scale" value="power3" />&nbsp;&nbsp;
		<input type="radio" name="scale" value="power2" />&nbsp;&nbsp;
		<input type="radio" name="scale" value="power1" />&nbsp;&nbsp;
		<input type="radio" name="scale" value="midline" />&nbsp;&nbsp;
		<input type="radio" name="scale" value="control1" />&nbsp;&nbsp;
		<input type="radio" name="scale" value="control2" />&nbsp;&nbsp;
		<input type="radio" name="scale" value="control3" />&nbsp;&nbsp;
		<input type="radio" name="scale" value="control4" /> Control</p>
